...
// import com.demonwav.mcdev.platform.foundation.generation.FoundationGenerationData
...
class FoundationModule<out T : AbstractModuleType<*>> constructor(facet: MinecraftFacet, type: T) : AbstractModule(
    facet
) {
    ...
    override fun isEventClassValid(eventClass: PsiClass, method: PsiMethod?) =
        FoundationConstants.EVENT_CLASS == eventClass.qualifiedName
    ...
    override fun doPreEventGenerate(psiClass: PsiClass, data: GenerationData?) {
        if (!psiClass.extendsOrImplements(FoundationConstants.LISTENER_CLASS)) {
            psiClass.addImplements(FoundationConstants.LISTENER_CLASS)
        }
    }

// TODO: Analyse usefulness
...
//        data: GenerationData?
//    ): PsiMethod? {
//        val bukkitData = data as FoundationGenerationData
//
//        val method = generateBukkitStyleEventListenerMethod(
//            chosenClass,
//            chosenName,
//            project,
//            FoundationConstants.HANDLER_ANNOTATION,
//            bukkitData.isIgnoreCanceled
//        ) ?: return null
//
//        if (bukkitData.eventPriority != "NORMAL") {
//            val list = method.modifierList
//            val annotation = list.findAnnotation(FoundationConstants.HANDLER_ANNOTATION) ?: return method
//
//            val value = JavaPsiFacade.getElementFactory(project)
//                .createExpressionFromText(
//                    FoundationConstants.EVENT_PRIORITY_CLASS + "." + bukkitData.eventPriority,
//                    annotation
//                )
//
...
//    }
    ...
    override fun checkUselessCancelCheck(expression: PsiMethodCallExpression): IsCancelled? {
        ...
        val annotation = method.modifierList.findAnnotation(FoundationConstants.HANDLER_ANNOTATION) ?: return null
        ...
        if (!context.extendsOrImplements(FoundationConstants.CANCELLABLE_CLASS)) {
            return null
        }
        ...
        if (resolve.name != FoundationConstants.EVENT_ISCANCELLED_METHOD_NAME) {
            return null
        }
    ...
    override fun shouldShowPluginIcon(element: PsiElement?): Boolean {
        ...
        val pluginInterface = JavaPsiFacade.getInstance(element.project)
            .findClass(FoundationConstants.PLUGIN, module.getModuleWithDependenciesAndLibrariesScope(false))
            ?: return false
