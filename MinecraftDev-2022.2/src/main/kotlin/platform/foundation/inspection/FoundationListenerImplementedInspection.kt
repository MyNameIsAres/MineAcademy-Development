...
package com.demonwav.mcdev.platform.foundation.inspection
...
class FoundationListenerImplementedInspection : BaseInspection() {
    ...
    override fun buildVisitor(): BaseInspectionVisitor {
        return object : BaseInspectionVisitor() {
            override fun visitClass(aClass: PsiClass) {
                if (
                    aClass.methods.none {
                        it.modifierList.findAnnotation(FoundationConstants.HANDLER_ANNOTATION) != null
                    }
                ) {
                    return
                }

                val inError = !aClass.extendsOrImplements(FoundationConstants.LISTENER_CLASS)
