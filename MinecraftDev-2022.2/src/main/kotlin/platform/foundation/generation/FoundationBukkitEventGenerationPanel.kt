...
package com.demonwav.mcdev.platform.foundation.generation
...
class FoundationBukkitEventGenerationPanel(chosenClass: PsiClass) : EventGenerationPanel(chosenClass) {
